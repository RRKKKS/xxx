...
class Config(object):
    LOGGER = True
    ALIVE_NAME = os.environ.get("ALIVE_NAME", "@R_R_B0")
    ...
    PRIVATE_GROUP_BOT_API_ID = int(os.environ.get("PRIVATE_GROUP_BOT_API_ID","1849405067") or 0)
    ...
    PM_LOGGER_GROUP_ID = int( os.environ.get("PM_LOGGER_GROUP_ID","1849405067") or os.environ.get("PM_LOGGR_BOT_API_ID") or 0 )
