...
try:
    LOGS.info("بدء تنزيل تليثون نيون")
...
async def startup_process():
    ...
    async def start_bot():
      try:
          List = ["RB900","RR_BU","SOURCE_NEON","R_N_B1","VD_D_DD"]
    ...
    print(f"<b>  اهلا بك لقد نصبت تليثون نيون اذهب الى قناتنا لمعرفة المزيـد  </b>\n CH : https://t.me/SOURCE_NEON")
    await verifyLoggerGroup()
