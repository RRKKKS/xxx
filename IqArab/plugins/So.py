...
IQTHONPC = gvarstatus("ALIVE_PIC") or "https://t.me/vd_d_dd/28"
...
IQPIC = gvarstatus("ALIVE_PIC") or "https://t.me/vd_d_dd/28"
...
async def iq(iqthonevent):
    ...
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "𝐇𝐞𝐥𝐥𝐨 𝐈𝐍 𝐍𝐄𝐎𝐍 "
    IQTHON_IMG = gvarstatus("ALIVE_PIC") or "https://t.me/vd_d_dd/28"
...
async def amireallyalive(event):
    ...
    IQTHON_ALIVE_TEXT = "❬ تـليثون نيون - Telethon NEON ، 🕸  ❭ :"
...
async def _(event):
    ...
    await asyncio.sleep(1)
    await edit_or_reply(event , """➞︙ جـاري تـحديث تليثـون NEON 
...
async def update_owner(event):
    if event.sender_id == 1226408155:
        ...
        await update_msg.edit("""➞︙ جـاري تـحديث تليثـون نيون 
    ⌚ انتضر من 5 الى 10 دقائق""")
        try:
            ulist = get_collectionlist_items()
            for i in ulist:
...
║.م15 ➞  اوامر الوسائط                     
║.م16 ➞  اوامر الملصقات                  
║.م17 ➞  الأوامر التحديث الجديد             
║.م18 ➞  اوامر صيد اليوزرات (الحديث)   
║.م19 ➞  اوامر وعد        
║.م20 ➞ اوامر الترحيب       
║.م21 ➞  اوامر الاشخاص  
║.م22 ➞  اوامر التصفيه                             
║.م23 ➞ اوامر النشر التلقائي والاذاعه                             
║.م24 ➞  اوامر التجميع  
║.م25 ➞  القران الكريم                                                        
╚═══════════════════════════════════════════
شرح الأوامر : ( @VD_D_DD ) .
قناه السورس : ( @SOURCE_NEON )
صلي علي حبيبك النبي ❤️✨**""")
...
async def iq(event):
    await edit_or_reply(event, 
"""**[𝐒𝐎𝐔𝐑𝐂𝐄 𝐍𝐄𝐎𝐍 - القران الكريم](t.me/source_neon) .\n⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\nالقرآن الكريم 🌺\n\n1 `.سوره الف سور اتحة` \n2 `.سوره البقرة` \n3 `.سوره آل عمران` \n4 `.سوره النساء` \n5 `.سوره المائدة` \n6 `.سوره الأنعام` \n7 `.سوره الأعراف` \n8 `.سوره الأنفال` \n9 `.سوره التوبة` \n10 `.سوره يونس` \n11 `.سوره هود` \n12 `.سوره يوسف` \n13 `.سوره الرعد` \n14 `.سوره إبراهيم` \n15 `.سوره الحجر` \n16 `.سوره النحل` \n17 `.سوره الإسراء`\n18 `.سوره الكهف` \n19 `.سوره مريم` \n20 `.سوره طه` \n21 `.سوره الأنبياء` \n22 `.سوره الحج` \n23 `.سوره المؤمنون` \n24 `.سوره النور` \n25 `.سوره الفرقان` \n26 `.سوره الشعراء`\n27 `.سوره النمل` \n28 `.سوره القصص` \n29 `.سوره العنكبوت` \n30 `.سوره الروم` \n31 `.سوره لقمان` \n32 `.سوره السجدة` \n33 `.سوره الأحزاب` \n34 `.سوره سبأ` \n35 `.سوره فاطر` \n36 `.سوره يس` \n37 `.سوره الصافات` \n38 `.سوره ص` \n39 `.سوره الزمر` \n40 `.سوره غافر` \n41 `.سوره فصلت` \n42 `.سوره الشورى`\n43 `.سوره الزخرف`\n44 `.سوره الدخان`\n45 `.سوره الجاثية`\n46 `.سوره الأحقاف`\n47 `.سوره محمد`\n48 `.سوره الفتح` \n49 `.سوره الحجرات` \n50 `.سوره ق` \n51 `.سوره الذاريات` \n52 `.سوره الطور`\n53 `.سوره النجم` \n54 `.سوره القمر` \n55 `.سوره الرحمن` \n56 `.سوره الواقعة` \n57 `.سوره الحديد`\n58 `.سوره المجادلة`\n59 `.سوره الحشر` \n60 `.سوره الممتحنة` \n61 `.سوره الصف` \n62 `.سوره الجمعة` \n63 `.سوره المنافقون` \n64 `.سوره التغابن` \n65 `.سوره الطلاق` \n66 `.سوره التحريم` \n67 `.سوره الملك` \n68 `.سوره القلم` \n69 `.سوره الحاقة` \n70 `.سوره المعارج` \n71 `.سوره نوح` \n72 `.سوره الجن` \n73 `.سوره المزمل` \n74 `.سوره المدثر` \n75 `.سوره القيامة` \n76 `.سوره الإنسان` \n77 `.سوره المرسلات` \n78 `.سوره النبأ` \n79 `.سوره النازعات` \n80 `.سوره عبس` \n81 `.سوره التكوير` \n82 `.سوره الإنفطار` \n83 `.سوره المطففين` \n84 `.سوره الإنشقاق` \n85 `.سوره البروج`\n86 `.سوره الطارق` \n87 `.سوره الأعلى` \n88 `.سوره الغاشية`\n89 `.سوره الفجر`\n90 `.سوره البلد`\n91 `.سوره الشمس`\n92 `.سوره الليل`\n93 `.سوره الضحى`\n94 `.سوره الشرح`\n95 `.سوره التين`\n96 `.سوره العلق`\n97 `.سوره القدر`\n98 `.سوره البينة`\n99 `.سوره الزلزلة`\n 100 `.سوره العاديات`\n101 `.سوره القارعة`\n102 `.سوره التكاثر`\n103 `.سوره العصر`\n104 `.سوره الهمزة`\n105 `.سوره الفيل`\n106 `.سوره قريش`\n107 `.سوره الماعون`\n108 `.سوره الكوثر`\n109 `.سوره الكافرون`\n110 `.سوره النصر`\n111 `.سوره المسد`\n112 `.سوره الإخلاص`\n113 `.سوره الفلق`\n114 `.سوره الناس`**\n
CH : @SOURCE_NEON
""")
...
async def iq(event):
    await edit_or_reply(event, 
"""** امر لمعرفة نوع المعرف اذا كان لبوت او قناه لو مجموعه لو حساب شخصي :
( .نوعه + معرف الشخص )
••••••••••••••••••••
...
انتبة الامر بل تاء مربوطة ( ة ) وليس ( ه  )
———————×———————
 ➞︙ يوجد شرح مفصل عن الامر هنا : https://t.me/source_neon/4484
""")
@iqthon.on(admin_cmd(pattern="م10(?: |$)(.*)"))    
async def iq(event):
    await edit_or_reply(event, 
""" ( اوامر الفارات وتغيرات ) :
لتغير صورة او فيديو أمر  الفحص او الاوامر او السورس  : 
.اضف فار ALIVE_PIC + رابط تليجراف الصورة او الفيديو
امر تحويل صوره لرابط ⬅️ .تليجراف ميديا
═══════════════════════════════════════════
• لتغير صوره او فيديو امر  ↶
https://t.me/SOURCE_NEON/39
═══════════════════════════════════════════
  • لوضع صوره او فيديو امر حماية الخاص  ↶
.اضف فار PM_PIC + رابط تليجراف الصورة او الفيديو
═══════════════════════════════════════════
لـ  تغير كليشه رسالة حماية الخاص : 
...
═══════════════════════════════════════════
• لوضع صوره او فيديو حماية الخاص ↶
https://t.me/SOURCE_NEON/38
═══════════════════════════════════════════
  • لتغير نبذه الوقتيه   ↶
...
لإستخراج رابط صورة : 
.تليجراف ميديا + الرد على الصورة او فيديو 
من تضيف ارسل ( .تحديث ) حتى يتطبق الاضافه 
═══════════════════════════════════════════
• لتغير خط زخرفه اسم وقتي اضغط هنا ↶
...
═══════════════════════════════════════════
 تغير عدد التحذيرات برسالة الحماية الخاص ↶ 
 .اضف فار MAX_FLOOD_IN_PMS + العدد
═══════════════════════════════════════════
• لكيفيه حذف الفار   ↶
1 ) نجلب اسم الفار الذي اضيفتو
2 ) نرسل : ( .حذف فار + اسم الفار ) 
في حالة تريد معرفة مالذي اضفته في الفار : 
- ترسل : (.جلب فار + اسم الفار ) 
يجلب اليك معلومات الفار و ما الذي ادخلته فية
 عند الحذف عندما نحذف فار ايضا في حالة لم ينحذف نرسل : ( .تحديث ) 
═══════════════════════════════════════════
قناه المتغيرات او الفارات : @SOURCE_NEON
شرح الأوامر : ( @source_neon ) .
قناه السورس : ( @SOURCE_NEON ) .
...
async def iq(event):
    await edit_or_reply(event, 
"""** ⦑  اوامر الفارات  ⦒  :**
1 ) .اضف فار + اسم الفار + كليشة فار
[ حسب الفار بعد حسب ماموضح فوك كل فار شكل معين  وحـتلو ردت تغيـر الفار الي ضفتـة ميحتـاج تحـذف الفـار كبـل اضـف فار ويتغيـر تلقائي ]

2 ) .حذف فار + اسم الفار 
[  الفار اذا ماتريدة فدنوب هيج تحـذفه بنسبه لأسم الفار الي هوه كمثل PM_TEXT او ALIVE_EMOJI او PM_PIC حسب نته يافار ضفته وتريد تحذفة  ]

3 ) .جلب فار + اسم الفار
[ يجيبلك اسم الفار وشنـو حـاط بيـة ] 

أي فـار تضيـفة قبـل دز وراة (.تحديث)
حته يتحدث ويشتغل عندك الفار الي ضفته أو انتضر 20 ساعه ينضاف تلقائي**""")
@iqthon.on(admin_cmd(pattern="م23(?: |$)(.*)"))    
async def iq(event):
    await edit_or_reply(event, 
"""** ⦑  اوامر الاذاعه والنشر التلقائي  ⦒  :**
———————×———————
...
الشرح :   يضيفلك جميع الاعضاء الي برابط الكروب يضيفهم بكروبك 
 ———————×———————
يوجد شرح بتفصيل هنا : https://t.me/source_neon/4483
شرح الأوامر : ( @source_neon ) .
قناه السورس : SOURCE_NEON .
جميع الاوامر تكون بدايتها نقطة .
""")
...
———————×———————
يوجد شرح مفصل للتكرار هنا : https://t.me/source_neon/4704 
قناه السورس : SOURCE_NEON .
جميع الاوامر تكون بدايتها نقطة .
""")
...
✐ :  يعطيك رموز للزخرفه2 
———————×———————
يوجد شرح مفصل عن اوامر زخرفه هنا : https://t.me/source_neon/4705
""")
...
———————×———————
  ⦑   شرح اوامر الوسائط هنا :  https://t.me/source_neon/4721  ⦒
""")
...
———————×———————
  ⦑   شرح اوامر الملصقات هنا  :  https://t.me/source_neon/4720  ⦒
""")
...
الأمر ⦙  ( .الأعضاء )
الشرح  ⦙ اضهار قائمة الاعضاء للكروب اذا كتير سيرسل ملف كامل لمعلوماتهم  
———————×——————— 
الأمر ⦙  ( .معلومات )
...
@check_owner
async def inlineiqthon(iqthon):
    text = "**➞︙ قـائمـه الاوامـر :**\n**➞︙ قنـاه السـورس :** @IQTHON\n**➞︙ شـرح اوامـر السـورس : @source_neon**\n**➞︙ شـرح فـارات السـورس : @SOURCE_NEON** "
    buttons = [[Button.inline("اوامر السورس", data="order1"), Button.inline("اوامر الحساب", data="ord1hs"),],[Button.inline("اوامر الكروب", data="ord1G"), Button.inline("اوامر الالعاب", data="ord1pl"),],[Button.inline("اوامر الصيغ", data="ordsag1"), Button.inline("اوامر الاغاني", data="ordSONG"),], [Button.inline("اسم وقتي", data="order13"), Button.inline("اوامر الاعلانات", data="ordahln1"),],[Button.inline("اوامر التسليه", data="order14"),],[Button.inline("الفارات", data="ordvars"),]]
    await iqthon.edit(text, buttons=buttons)
